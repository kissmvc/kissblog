...
<head>
	...
	<!-- CKEDITOR -->
	<script src="<?php echo $page->assets('theme/js/ckeditor/ckeditor.js'); ?>" type="text/javascript"></script>
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-sm-2 left">
				...
				<ul>
					<li><a href="<?php echo $page->getUrl(); ?>">Úvod</a></li>
					<li><a href="<?php echo $page->getUrl('index.php?page=clanky'); ?>">Články</a></li>
					<li><a href="<?php echo $page->getUrl('index.php?page=category'); ?>">Kategórie</a></li>
					<li><a href="<?php echo $page->getUrl('index.php?page=login&action=logout'); ?>">Odhlásiť</a></li>
				</ul>
